...
**DBSCAN**  is a powerful clustering algorithm that groups data points based on **density** rather than distance to centroids.  
...
Unlike algorithms like k-means, DBSCAN does **not require specifying the number of clusters in advance**, and it can discover clusters of arbitrary shapes.
